...
String SW_VERSION = "3.03"; // Changed write_to_pc() to stay compatible with 
                            // the V2.1 from John's PC program
...
#if 0
// original code for the <2.1 versions of John's PC program
void write_to_pc(){
...
#else
//
// Below is the code to work with the 2.1 version of the PC app
// Code provided by jdr from Dutchtronix
//
/* =================== Send values to PC =================================== */
...
void getTime() {         
 ...
 tMins = mins;     // update the measurement duration timer
